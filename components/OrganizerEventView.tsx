                ...
                {activeTab === "Overview" && (
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { label: "Total Revenue", value: formatCurrency(stats.revenue), trend: "+12%" },
                                { label: "Tickets Sold", value: stats.sold, sub: `/ ${stats.capacity}`, trend: "+5%" },
                                { label: "Page Views", value: stats.views.toLocaleString(), trend: "+24%" },
